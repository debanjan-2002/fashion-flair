        ...
        <>
            ...
            >
                <img
                    src="/bg/bot-1.png"
                    alt=""
                    className="bot-1 absolute motion-safe:animate-bounce"
                    style={bot1Style}
                />
                <img
                    src="/bg/bot-2.png"
                    alt=""
                    className="bot absolute motion-safe:animate-bounce"
                    style={bot2Style}
                />
                <img
                    src="/bg/dog.png"
                    alt=""
                    className="dog absolute"
                    style={dogStyle}
                />
                <img
                    src="/bg/girl.png"
                    alt=""
                    className="girl absolute"
                    style={girlStyle}
                />
                <img
                    src="/bg/guitar.png"
                    alt=""
                    className="guitar absolute"
                    style={guitarStyle}
                />
                <img
                    src="/bg/skates.png"
                    alt=""
                    className="skates absolute"
                    style={skateStyle}
                />
