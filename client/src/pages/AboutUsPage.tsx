                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="md:order-1">
                            ...
                            <p className="text-gray-700 mb-4">
                                ...
                                more than just clothing; it's an expression of
                                your personality and a way to showcase your
                                unique style. Our app is designed to empower you
                                with the latest fashion trends, AI-driven outfit
                                suggestions, and a curated collection of
                                top-quality clothing, accessories, and footwear.
                            </p>
                        </div>
