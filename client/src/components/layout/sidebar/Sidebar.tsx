    ...
    return (
        <div className="sidebar flex flex-col items-center justify-between h-full w-72 py-3 pr-6 text-white">
            <div className="flex flex-col w-full">
                ...
                <div className="flex flex-col w-full">
                    <NavLink to="/" className="py-3 px-6 hover:bg-zinc-800 rounded rounded-lg flex flex-row gap-x-3 mb-3 cursor-pointer">
                    ...
                    <NavLink to="/about" className="py-3 px-6 hover:bg-zinc-800 rounded rounded-lg flex flex-row gap-x-3 mb-3 cursor-pointer">
                    ...
                    <NavLink to="/how-to-use" className="py-3 px-6 hover:bg-zinc-800 rounded rounded-lg flex flex-row gap-x-3 mb-3 cursor-pointer">
                    ...
                    <NavLink to="/chat" className="py-3 px-6 bg-zinc-800 rounded rounded-lg flex flex-row gap-x-3 mb-3 cursor-pointer">
                    ...
                    <NavLink to="/faq" className="py-3 px-6 hover:bg-zinc-800 rounded rounded-lg flex flex-row gap-x-3 mb-3 cursor-pointer">
            ...
            <button className="py-3 px-6 rounded rounded-lg w-full flex flex-row justify-between hover:bg-zinc-800 border-t-2 border-zinc-800">
                <p>Logout</p>
